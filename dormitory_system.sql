...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2024 at 01:16 PM
...
CREATE TABLE `apartments` (
  ...
  `payment_end_day` int(2) NOT NULL,
...
INSERT INTO `apartments` (`id`, `name`, `address`, `province_id`, `amphure_id`, `district_id`, `zip_code`, `phone_number`, `email`, `layers`, `bill_day`, `payment_end_day`, `created_by`) VALUES
(1, 'ดกหก', 'ดกด้ด้ห', 6, 91, 150202, 14140, '086-927-9177', 'Supapit9177@gmail.com', 3, 14, 14, 0),
(2, 'หพเด้', 'ก้ดเด้กด', 9, 117, 180302, 17120, '086-927-9177', 'Supapit9177@gmail.com', 3, 15, 14, 0),
(4, 'บ้านพันธ์แก้ว', '9-131 ม.1', 25, 366, 361204, 36150, '095-636-9191', 'Supapit9177@gmail.com', 3, 13, 14, 0),
(5, 'บ้านพันธ์แก้ว', '9-131 ม.1', 9, 116, 180203, 17110, '095-636-9191', 'Supapit9177@gmail.com', 3, 11, 10, 0),
(6, 'บ้านพันธ์แก้ว', '9-131 ม.1', 5, 84, 141103, 13170, '095-636-9191', 'Supapit9177@gmail.com', 3, 14, 14, 0),
(7, 'บ้านพันธ์แก้ว', '9-131 ม.1', 4, 68, 130303, 12110, '095-636-9191', 'Supapit9177@gmail.com', 3, 13, 10, 0),
(8, 'บ้านพันธ์แก้ว', '9-131 ม.1', 8, 110, 170204, 16130, '095-636-9191', 'Supapit9177@gmail.com', 3, 17, 17, 0),
(9, 'บ้านพันธ์แก้ว', '9-131 ม.1', 3, 60, 120303, 11140, '095-636-9191', 'Supapit9177@gmail.com', 3, 12, 11, 0),
(10, 'บ้านพันธ์แก้ว', '9-131 ม.1', 10, 125, 190310, 18230, '095-636-9191', 'Supapit9177@gmail.com', 3, 13, 13, 0),
(11, 'บ้านพันธ์แก้ว', '9-131 ม.1', 12, 154, 210402, 21210, '095-636-9191', 'Supapit9177@gmail.com', 3, 15, 14, 0),
(12, 'บ้านพันธ์แก้ว', '9-131 ม.1', 8, 111, 170303, 16150, '095-636-9191', 'Supapit9177@gmail.com', 3, 13, 10, 9),
(13, 'ดกหก', '9-131 ม.1', 8, 111, 170303, 16150, '095-636-9191', 'Supapit9177@gmail.com', 3, 10, 12, 11),
(14, 'บ้านพันธ์แก้ว', '9-131 ม.1', 49, 709, 620101, 62000, '095-636-9191', 'Supapit9177@gmail.com', 3, 31, 7, 12),
(17, 'หอพักกู๊ดแลนด์', '85/5', 9, 116, 180203, 17110, '0956369191', 'Supapit9177@gmail.com', 3, 10, 13, 13),
(18, 'หอพักกู๊ดแลนด์', '85/5', 6, 92, 150302, 14130, '0956369191', 'Supapit9177@gmail.com', 3, 14, 12, 16);
...
INSERT INTO `bank_accounts` (`id`, `account_name`, `account_number`, `bank_name`, `account_type`, `qr_code`, `apartment_id`, `created_at`) VALUES
(1, 'ศุภาพิชญ์ พันธ์แก้ว', '6850134203', 'กรุงไทย', '', 'uploads/462546508_894952662151705_4016002307231790434_n.jpg', 14, '2024-10-12 20:56:02');
...
CREATE TABLE `billing_statements` (
  ...
  `internet_cost` decimal(10,2) NOT NULL,
  `room_cost` decimal(10,2) NOT NULL,
  `total_cost` decimal(10,2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `electricity_meter` float DEFAULT NULL,
  `water_meter` float DEFAULT NULL,
  `electricity_meter_previous` decimal(10,2) NOT NULL DEFAULT 0.00,
  `water_meter_previous` decimal(10,2) NOT NULL DEFAULT 0.00,
  `expense_type` varchar(20) NOT NULL DEFAULT 'all'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `billing_statements` (`id`, `user_id`, `apartment_id`, `room_number`, `month`, `year`, `electricity_cost`, `water_cost`, `internet_cost`, `room_cost`, `total_cost`, `created_at`, `electricity_meter`, `water_meter`, `electricity_meter_previous`, `water_meter_previous`, `expense_type`) VALUES
(72, 12, 14, '103', 'ตุลาคม', 2564, 315.00, 100.00, 100.00, 3000.00, 3515.00, '2024-10-09 19:17:02', 255, 0, 210.00, 0.00, 'all'),
(74, 12, 14, '104', 'มิถุนายน', 2564, 182.00, 100.00, 100.00, 3000.00, 3382.00, '2024-10-09 19:20:01', 266, 0, 240.00, 0.00, 'all'),
(75, 12, 14, '101', 'พฤศจิกายน', 2564, 756.00, 100.00, 100.00, 3000.00, 3956.00, '2024-10-09 19:52:21', 352, 0, 244.00, 0.00, 'all'),
(76, 12, 14, '201', 'พฤศจิกายน', 2567, 861.00, 100.00, 100.00, 3000.00, 4061.00, '2024-10-09 19:55:48', 355, 0, 232.00, 0.00, 'all'),
(77, 12, 14, '105', 'ธันวาคม', 2567, 770.00, 100.00, 100.00, 3000.00, 3970.00, '2024-10-09 19:57:19', 421, 0, 311.00, 0.00, 'all'),
(79, 12, 14, '103', 'ตุลาคม', 2567, 1134.00, 100.00, 100.00, 3000.00, 4334.00, '2024-10-11 20:59:08', 362, 0, 200.00, 0.00, 'all'),
(80, 16, 18, '103', 'ตุลาคม', 2567, 308.00, 100.00, 100.00, 2500.00, 3008.00, '2024-10-12 16:55:25', 255, 0, 211.00, 0.00, 'all'),
(85, 12, 14, '103', 'ธันวาคม', 2567, 2884.00, 100.00, 100.00, 3000.00, 6084.00, '2024-10-12 18:35:26', 2954, 0, 2542.00, 0.00, 'all'),
(88, 16, 18, '103', 'ธันวาคม', 2567, 3892.00, 100.00, 100.00, 2500.00, 6592.00, '2024-10-12 19:02:38', 3210, 0, 2654.00, 0.00, 'all'),
(95, 12, 14, '103', 'เมษายน', 2568, 1379.00, 100.00, 100.00, 3000.00, 4579.00, '2024-10-12 20:12:34', 2511, 0, 2314.00, 0.00, 'all'),
(96, 12, 14, '103', 'พฤษภาคม', 2568, 1312.00, 100.00, 100.00, 3000.00, 4512.00, '2024-10-13 16:02:36', 2342, 0, 2178.00, 0.00, 'all'),
(98, 12, 14, '103', 'พฤษภาคม', 2567, 1160.00, 100.00, 100.00, 3000.00, 4360.00, '2024-10-14 03:26:46', 2123, 0, 1978.00, 0.00, 'all'),
(100, 12, 14, '103', 'กรกฎาคม', 2568, 1944.00, 100.00, 100.00, 3000.00, 5144.00, '2024-10-14 03:37:27', 3454, 0, 3211.00, 0.00, 'all'),
(103, 12, 14, '103', 'พฤศจิกายน', 2568, 2408.00, 100.00, 100.00, 3000.00, 5608.00, '2024-10-14 04:54:57', 3444, 0, 3143.00, 0.00, 'all');
...
INSERT INTO `owner` (`owner_id`, `user_id`, `name`, `contact_info`) VALUES
('', 12, 'Default Name', NULL);
...
INSERT INTO `payment_slips` (`id`, `receipt_id`, `slip_image`, `uploaded_at`) VALUES
(3, 191, 'uploads/4bbd2629e8cb3c82ec560d2fd1d6bcce.jpg', '2024-10-13 14:36:03'),
(8, 192, 'uploads/62319314b20883a40132b95b8884cb2c.jpg', '2024-10-13 16:54:36'),
(15, 196, 'uploads/IMG_6725.jpg', '2024-10-14 04:17:14'),
(22, 197, 'uploads/IMG_6275.jpg', '2024-10-14 04:54:20'),
(23, 198, 'uploads/IMG_6725.jpg', '2024-10-14 04:55:34');
...
CREATE TABLE `receipts` (
  ...
  `electricity_meter_previous` decimal(10,2) DEFAULT NULL,
  `water_meter` decimal(10,2) DEFAULT NULL,
  `water_meter_previous` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `receipts` (`id`, `user_id`, `room_number`, `month`, `year`, `electricity_cost`, `water_cost`, `internet_cost`, `room_cost`, `total_cost`, `created_at`, `apartment_id`, `electricity_meter`, `electricity_meter_previous`, `water_meter`, `water_meter_previous`, `viewed`, `status`) VALUES
(166, 12, '105', 'ธันวาคม', 2567, 770.00, 100.00, 100.00, 3000.00, 3970.00, '2024-10-11 18:21:03', 14, 421.00, 311.00, 0.00, 0.00, 0, 'unpaid'),
(167, 12, '201', 'พฤศจิกายน', 2567, 861.00, 100.00, 100.00, 3000.00, 4061.00, '2024-10-11 18:21:03', 14, 355.00, 232.00, 0.00, 0.00, 0, 'unpaid'),
(168, 12, '101', 'พฤศจิกายน', 2564, 756.00, 100.00, 100.00, 3000.00, 3956.00, '2024-10-11 18:21:03', 14, 352.00, 244.00, 0.00, 0.00, 0, 'unpaid'),
(169, 12, '104', 'มิถุนายน', 2564, 182.00, 100.00, 100.00, 3000.00, 3382.00, '2024-10-11 18:21:03', 14, 266.00, 240.00, 0.00, 0.00, 0, 'unpaid'),
(173, 12, '201', 'พฤศจิกายน', 2567, 861.00, 100.00, 100.00, 3000.00, 4061.00, '2024-10-12 16:25:00', 14, 355.00, 232.00, 0.00, 0.00, 0, 'unpaid'),
(175, 12, '103', 'ตุลาคม', 2567, 1134.00, 100.00, 100.00, 3000.00, 4334.00, '2024-10-12 16:28:38', 14, 362.00, 200.00, 0.00, 0.00, 1, 'unpaid'),
(176, 16, '103', 'ตุลาคม', 2567, 308.00, 100.00, 100.00, 2500.00, 3008.00, '2024-10-12 16:56:42', 18, 255.00, 211.00, 0.00, 0.00, 0, 'unpaid'),
(183, 12, '103', 'ธันวาคม', 2567, 2884.00, 100.00, 100.00, 3000.00, 6084.00, '2024-10-12 18:52:45', 14, 2954.00, 2542.00, 0.00, 0.00, 1, 'unpaid'),
(185, 16, '103', 'ธันวาคม', 2567, 3892.00, 100.00, 100.00, 2500.00, 6592.00, '2024-10-12 19:02:47', 18, 3210.00, 2654.00, 0.00, 0.00, 0, 'unpaid'),
(186, 12, '103', 'กันยายน', 2567, 7.00, 100.00, 100.00, 3000.00, 3207.00, '2024-10-12 19:43:07', 14, 0.00, 0.00, 0.00, 0.00, 1, 'unpaid'),
(187, 12, '103', 'สิงหาคม', 2567, 7.00, 100.00, 100.00, 3000.00, 3207.00, '2024-10-12 19:55:43', 14, 0.00, 0.00, 0.00, 0.00, 1, 'unpaid'),
(188, 12, '103', 'พฤศจิกายน', 2567, 7.00, 100.00, 100.00, 3000.00, 3207.00, '2024-10-12 19:56:32', 14, 0.00, 0.00, 0.00, 0.00, 1, 'unpaid'),
(189, 12, '103', 'มกราคม', 2568, 7.00, 100.00, 100.00, 3000.00, 3207.00, '2024-10-12 19:57:23', 14, 0.00, 0.00, 0.00, 0.00, 1, 'unpaid'),
(190, 12, '103', 'กุมภาพันธ์', 2568, 7.00, 100.00, 100.00, 3000.00, 3207.00, '2024-10-12 19:58:24', 14, 0.00, 0.00, 0.00, 0.00, 1, 'unpaid'),
(191, 12, '103', 'เมษายน', 2568, 1379.00, 100.00, 100.00, 3000.00, 4579.00, '2024-10-12 20:12:39', 14, 2511.00, 2314.00, 0.00, 0.00, 1, 'paid'),
(192, 12, '103', 'พฤษภาคม', 2568, 1312.00, 100.00, 100.00, 3000.00, 4512.00, '2024-10-13 16:02:49', 14, 2342.00, 2178.00, 0.00, 0.00, 1, 'paid'),
(196, 12, '103', 'กันยายน', 2568, 8.00, 100.00, 100.00, 3000.00, 3208.00, '2024-10-14 03:49:40', 14, 0.00, 0.00, 0.00, 0.00, 0, 'paid'),
(197, 12, '103', 'ตุลาคม', 2568, 8.00, 100.00, 100.00, 3000.00, 3208.00, '2024-10-14 04:18:44', 14, 0.00, 0.00, 0.00, 0.00, 0, 'paid'),
(198, 12, '103', 'พฤศจิกายน', 2568, 2408.00, 100.00, 100.00, 3000.00, 5608.00, '2024-10-14 04:55:02', 14, 3444.00, 3143.00, 0.00, 0.00, 1, 'paid');
...
INSERT INTO `renter` (`id`, `apartment_id`, `name`, `phone`, `email`, `created_at`, `user_id`, `username`, `room_number`) VALUES
(77, 14, 'ศุภาพิชญ์ พันธ์แก้ว', '0869279177', 'Supapit9177@gmail.com', '2024-10-11 20:32:51', 14, 'Jewelryx', '103'),
(78, 18, 'ศุภาพิชญ์ พันธ์แก้ว', '0869279177', 'myseebelle@gmail.com', '2024-10-11 20:34:34', 15, 'asdf', '103');
...
CREATE TABLE `rooms` (
  ...
  `floor_number` int(11) NOT NULL,
  `apartment_id` int(11) NOT NULL,
  `renter_count` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `rooms` (`id`, `room_number`, `status`, `floor_number`, `apartment_id`, `renter_count`) VALUES
(15, '101', 'vacant', 1, 14, 0),
(16, '102', 'occupied', 1, 14, 1),
(17, '103', 'occupied', 1, 14, 1),
(18, '104', 'occupied', 1, 14, 1),
(19, '105', 'occupied', 1, 14, 1),
(20, '201', 'occupied', 2, 14, 1),
(21, '202', 'occupied', 2, 14, 1),
(22, '203', 'occupied', 2, 14, 1),
(23, '204', 'occupied', 2, 14, 1),
(25, '103', 'occupied', 1, 18, 1),
(28, '205', '', 2, 14, 2),
(29, '301', 'occupied', 3, 14, 1),
(31, '302', 'occupied', 3, 14, 2),
(39, '303', 'occupied', 3, 14, 2);
...
CREATE TABLE `service_rates` (
  `id` int(11) NOT NULL,
  `electrical_unit` decimal(10,2) NOT NULL,
  `electrical_unit_type` enum('monthly','per_unit') NOT NULL,
  `water_unit_type` enum('monthly','per_unit') NOT NULL,
  `water_unit_value` decimal(10,2) DEFAULT NULL,
  `room_unit` decimal(10,2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `apartment_id` int(11) NOT NULL,
  `internet_unit` decimal(10,2) NOT NULL,
  `internet_unit_type` enum('monthly','free') NOT NULL DEFAULT 'monthly'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `service_rates` (`id`, `electrical_unit`, `electrical_unit_type`, `water_unit_type`, `water_unit_value`, `room_unit`, `created_at`, `updated_at`, `apartment_id`, `internet_unit`, `internet_unit_type`) VALUES
(11, 8.00, 'per_unit', 'monthly', 100.00, 2500.00, '2024-10-06 12:04:24', '2024-10-20 15:32:29', 14, 100.00, 'monthly');
...
INSERT INTO `users` (`user_id`, `username`, `password`, `role`, `created_at`, `email`, `firstname`, `lastname`, `phone`, `reset_token`, `reset_token_expiry`) VALUES
(12, 'Jewelryxx', '$2y$10$XqguDnFbp9oq..R62DvDo.B9poXrDqUjQoJ5OhIteWJK2gpMc1lEm', 'owner', '2024-09-26 11:07:23', 'Supapit9177@gmail.com', 'ศุภาพิชญ์', 'พันธ์แก้ว', '095-636-9191', '1058e5c0c786e24832d37257b66e318c30b6b0d781b1fe4bb29ee13e9481ffb7d1397c5cd0809c927c9b85c30b443ac6351d', NULL),
(14, 'Jewelryx', '$2y$10$u/6pjubR1VvvnKteL1GlPOZVqFvtVuR8i6DKrohlclVMtPuCTfaZK', 'renter', '2024-10-05 21:13:29', 'ccoltxx.94@gmail.com', 'ศุภาพิชญ์', 'พันธ์แก้ว', '0956369191', 'adc79b4a397a98f28b5b5889d9a8e2ef28e14ad2ef9d7f6c557ef7031889e8e4f9a58b7a9d372da838d47bf361a0b8bbd23b', NULL),
(15, 'asdf', '$2y$10$eIUuR1ud9bcbsZS07Oz2Oup32jIekaWrVwbs8RkE0TS13qefhFYtS', 'renter', '2024-10-06 10:09:05', 'myseebelle@gmail.com', 'ศุภาพิชญ์', 'พันธ์แก้ว', '0956369191', NULL, NULL),
(16, 'aaaa', '$2y$10$viJVEzAO5JDnXxuUDDr4wu0DFqj.b1U0ivIntC/U6SYSv.tgsM3Ve', 'owner', '2024-10-06 10:12:28', 'supapitp64@nu.ac.th', 'ศุภาพิชญ์', 'พันธ์แก้ว', '0956369191', NULL, NULL),
(17, 'test', '$2y$10$ge4KcIZhlm1jREAKQ3X.7elFHgh/IY.trivwZ7SqfntWQLjd16Xt2', 'owner', '2024-10-14 06:00:07', 'Supapit1605@gmail.com', 'ศุภาพิชญ์', 'พันธ์แก้ว', '0956369191', NULL, NULL);
...
--
ALTER TABLE `apartments`
  ADD CONSTRAINT `apartments_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`id`),
  ADD CONSTRAINT `apartments_ibfk_2` FOREIGN KEY (`amphure_id`) REFERENCES `amphures` (`id`),
  ADD CONSTRAINT `apartments_ibfk_3` FOREIGN KEY (`district_id`) REFERENCES `districts` (`id`);

--
-- Constraints for table `bank_accounts`
--
ALTER TABLE `bank_accounts`
  ADD CONSTRAINT `bank_accounts_ibfk_1` FOREIGN KEY (`apartment_id`) REFERENCES `apartments` (`id`);

--
-- Constraints for table `billing_statements`
--
ALTER TABLE `billing_statements`
  ADD CONSTRAINT `billing_statements_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `billing_statements_ibfk_2` FOREIGN KEY (`apartment_id`) REFERENCES `apartments` (`id`);

--
-- Constraints for table `owner`
--
ALTER TABLE `owner`
  ADD CONSTRAINT `owner_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `payment_slips`
  ADD CONSTRAINT `payment_slips_ibfk_1` FOREIGN KEY (`receipt_id`) REFERENCES `receipts` (`id`);
...
--
ALTER TABLE `renter`
  ADD CONSTRAINT `renter_ibfk_1` FOREIGN KEY (`apartment_id`) REFERENCES `apartments` (`id`);

--
-- Constraints for table `rooms`
--
ALTER TABLE `rooms`
  ADD CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`apartment_id`) REFERENCES `apartments` (`id`);
COMMIT;
