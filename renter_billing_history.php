...
// ดึงข้อมูลผู้เช่าและหมายเลขห้องที่ผู้เช่าลงทะเบียน
$renter_query = "
...
// ดึงข้อมูลใบเสร็จทั้งหมดสำหรับหมายเลขห้องที่ผู้เช่าลงทะเบียน
$receipts_query = "
...
<head>
    ...
    <title>ประวัติบิลค่าเช่าของผู้เช่า</title>
    ...
    <link rel="stylesheet" href="assets/css/renter_billing_history.css">
...
<div class="container">
    ...
    <div class="container">
    <h1>ประวัติบิลค่าเช่าของผู้เช่า</h1>
    ...
    <?php while ($receipt = $receipts_result->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                <?php 
                    // แก้ไขสถานะที่แสดง
                    $status = htmlspecialchars($receipt['status']);
                    if ($status === 'unpaid') {
                        echo 'ยังไม่ได้ชำระเงิน';
                    } elseif ($status === 'paid') {
                        echo 'ชำระเงินแล้ว';
                    } else {
                        echo $status; // ในกรณีที่มีสถานะอื่น
                    }
                ?>
            </td>
            <td>
